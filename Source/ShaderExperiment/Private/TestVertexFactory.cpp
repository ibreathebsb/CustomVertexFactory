...
void FTestVertexFactory::InitRHI(FRHICommandListBase& RHICmdList)
{
...
IMPLEMENT_VERTEX_FACTORY_TYPE(FTestVertexFactory, "/Shaders/VS.ush",
...
void FTestVertexBuffer::InitRHI(FRHICommandListBase& RHICmdList)
{
...
void FTestIndexBuffer::InitRHI(FRHICommandListBase& RHICmdList)
{
